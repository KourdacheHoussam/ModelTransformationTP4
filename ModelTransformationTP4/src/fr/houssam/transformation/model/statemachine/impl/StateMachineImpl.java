 ...
 * <ul>
 *   <li>{@link fr.houssam.transformation.model.statemachine.impl.StateMachineImpl#getRegion <em>Region</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateMachineImpl extends BehaviorImpl implements StateMachine {
	...
	public EList<Region> getRegion() {
		if (region == null) {
			region = new EObjectContainmentWithInverseEList<Region>(Region.class, this, StatemachinePackage.STATE_MACHINE__REGION, StatemachinePackage.REGION__MACHINE);
		}
		return region;
	}
