 ...
 * <ul>
 *   <li>{@link fr.houssam.transformation.model.statemachine.impl.PseudoStateImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PseudoStateImpl extends VertexImpl implements PseudoState {
	...
	public void setKind(PseudoStateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatemachinePackage.PSEUDO_STATE__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatemachinePackage.PSEUDO_STATE__KIND:
				return getKind();
		}
