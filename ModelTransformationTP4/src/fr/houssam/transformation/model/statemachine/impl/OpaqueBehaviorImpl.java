 ...
 * <ul>
 *   <li>{@link fr.houssam.transformation.model.statemachine.impl.OpaqueBehaviorImpl#getBody <em>Body</em>}</li>
 *   <li>{@link fr.houssam.transformation.model.statemachine.impl.OpaqueBehaviorImpl#getLanguage <em>Language</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OpaqueBehaviorImpl extends BehaviorImpl implements OpaqueBehavior {
	...
	protected EClass eStaticClass() {
		return StatemachinePackage.Literals.OPAQUE_BEHAVIOR;
	}
	...
	public EList<String> getBody() {
		if (body == null) {
			body = new EDataTypeUniqueEList<String>(String.class, this, StatemachinePackage.OPAQUE_BEHAVIOR__BODY);
		}
		return body;
	}
	...
	public EList<String> getLanguage() {
		if (language == null) {
			language = new EDataTypeUniqueEList<String>(String.class, this, StatemachinePackage.OPAQUE_BEHAVIOR__LANGUAGE);
		}
		return language;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatemachinePackage.OPAQUE_BEHAVIOR__BODY:
				return getBody();
			case StatemachinePackage.OPAQUE_BEHAVIOR__LANGUAGE:
				return getLanguage();
		}
