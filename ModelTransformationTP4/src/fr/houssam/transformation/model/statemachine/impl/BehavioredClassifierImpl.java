 ...
 * <ul>
 *   <li>{@link fr.houssam.transformation.model.statemachine.impl.BehavioredClassifierImpl#getOwnedBehavior <em>Owned Behavior</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BehavioredClassifierImpl extends MinimalEObjectImpl.Container implements BehavioredClassifier {
	/**
	...
	protected EClass eStaticClass() {
		return StatemachinePackage.Literals.BEHAVIORED_CLASSIFIER;
	}
	...
	public EList<Behavior> getOwnedBehavior() {
		if (ownedBehavior == null) {
			ownedBehavior = new EObjectContainmentWithInverseEList<Behavior>(Behavior.class, this, StatemachinePackage.BEHAVIORED_CLASSIFIER__OWNED_BEHAVIOR, StatemachinePackage.BEHAVIOR__CONTEXT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StatemachinePackage.BEHAVIORED_CLASSIFIER__OWNED_BEHAVIOR:
